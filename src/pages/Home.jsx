  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-exaa-100 via-white to-bloom-100/50 exaa-grid-overlay">
        ...
        <div className="relative exaa-container grid grid-cols-1 py-14 sm:py-20 lg:grid-cols-12 lg:gap-x-12 lg:gap-y-0 lg:py-24">
          <div className="order-1 max-w-xl lg:col-span-6">
            ...
            <p className="hero-stagger hero-stagger-3 mt-6 max-w-md text-base leading-relaxed text-exaa-700">
              BISE Gujranwala–affiliated education from Montessori to Matric — with professional
              teaching staff, Hifz-ul-Quran, merit scholarships, student societies, and strong academic results.
            </p>
          ...
          <div className="relative order-2 mt-10 min-h-[22rem] w-full lg:order-2 lg:col-span-6 lg:mt-0">
            ...
            <div className="relative mx-auto h-[min(58vh,28rem)] w-full max-w-lg overflow-hidden rounded-xl border border-accent-100/90 bg-white shadow-[0_24px_56px_-12px_rgba(30,138,122,0.14),0_16px_40px_-8px_rgba(196,180,252,0.12)] xl:max-w-2xl lg:ml-auto">
      ...
      <section className="relative border-b border-accent-100/70 bg-gradient-to-br from-white via-zest-50/30 to-accent-50/40 py-16 sm:py-24">
        <div className="relative exaa-container">
          <Reveal>
            <SectionHeading
              eyebrow="Start here"
            ...
            {programs.map((p, i) => {
              ...
              return (
                <Reveal key={p.title} delay={i * 60}>
                  <TiltSurface className="h-full rounded-xl" maxTilt={5}>
                    <article className="group exaa-card-shine flex h-full flex-col items-center rounded-xl border border-exaa-900/[0.08] bg-white p-6 text-center shadow-sm transition hover:-translate-y-0.5 hover:border-accent-500/[0.2] hover:shadow-md">
                      <span className="exaa-icon-tile exaa-icon-tile-muted size-11">
                      ...
                      <span className="exaa-hover-rule mx-auto mt-5 block w-full max-w-[4rem]" aria-hidden />
                    </article>
                  </TiltSurface>
                </Reveal>
              )
          ...
          <Reveal delay={120}>
            <ul className="mx-auto mt-8 flex max-w-4xl flex-wrap justify-center gap-2">
              {homepageHighlights.map((highlight) => (
                <li
                  key={highlight}
                  className="rounded-full border border-exaa-200/90 bg-exaa-50/80 px-3 py-1.5 text-xs font-medium text-exaa-700"
                >
                  {highlight}
                </li>
              ))}
      ...
      <section className="relative border-t border-exaa-200/70 bg-exaa-50 py-16 sm:py-24">
        <div className="relative exaa-container">
          <Reveal>
            <SectionHeading
          ...
          <Reveal delay={80} className="mt-12 flex justify-center">
            <AcademicResultCard variant="summary" />
          </Reveal>
          <Reveal delay={100} className="mt-10 text-center">
            <Link
              to="/academics"
              className="group inline-flex items-center gap-2 rounded-lg border border-exaa-900/12 bg-white px-4 py-2.5 text-sm font-semibold text-exaa-900 transition hover:border-accent-500/30 hover:bg-exaa-50"
            >
              Full results & achievers
              <ArrowRight
