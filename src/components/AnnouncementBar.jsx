...
import { announcementSlides, hours } from '../data/siteContent'
...
export default function AnnouncementBar() {
  ...
  return (
    ...
    >
      ...
      <div className="relative exaa-container flex flex-col items-center gap-2 py-2.5 pb-3 sm:gap-1.5 sm:py-3 sm:pb-3.5">
        <p
          key={slide?.id ?? index}
